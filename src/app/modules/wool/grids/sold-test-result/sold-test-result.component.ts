...
@Component({
  selector: 'app-sold-test-result',
  templateUrl: './sold-test-result.component.html',
  styleUrls: ['./sold-test-result.component.scss']
})
export class SoldTestResultComponent implements OnInit {
      ...
      header: {
        columns: [
          ...
          },
          {
            ...
            displayName: 'FD - Co-efficient of variaty',
            width: '180px'
          },
          {
          ...
          // {
          //   objectKey: 'REPLACEUPDATE',
          //   displayName: 'Replace / Update',
          //   width: '120px'
          // },
          // {
          //   objectKey: 'COSTCentsperKg',
          ...
          {
            objectKey: 'SD_DateCertiRecColour',
          ...
          {
            objectKey: 'SD_SuperfineTestRequested',
            displayName: 'Superfine Test Requested',
            width: '170px'
          },
          {
            objectKey: 'SD_AmTestRequested',
            displayName: 'AM Test Requested',
            width: '140px'
          },
          {
            objectKey: 'SD_ColourTestRequested',
            displayName: 'Color Test Requested',
            width: '150px'
          },
          {
            objectKey: 'SD_OfdaRequested',
  ...
  async getDataSource(params: any) {
    const response: any = await this.woolSearchService.getSoldTestResultsData(params).toPromise();
  ...
  actionClick(event: any) {
    switch (event.action) {
      ...
      case 'FilterClear_Click':
        ...
        break;
      case 'Link':
        this.openBaleDetailModal.emit({baleId: this.dataSource[event.rowIndex].SD_FolioUniqueId, isSoldBale: true});
        break;
    }
  }
  ...
  getExcelData() {
    ...
    this.apiESaleyardService.postGetFile('awhwool/ExportToExcelSoldTestResults', bodyData, 'blob')
      .subscribe(
        (resultBlob: Blob) => {
