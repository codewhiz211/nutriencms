...
@Component({
  selector: 'app-sold-appraisal',
  templateUrl: './sold-appraisal.component.html',
  styleUrls: ['./sold-appraisal.component.scss']
})
export class SoldAppraisalComponent implements OnInit {
        ...
        header: {
          columns: [
            ...
            },
            {
              ...
              displayName: 'Estimated Gross Proceeds',
              width: '170px'
            },
            {
    ...
    async getDataSource(params: any) {
      const response: any = await this.woolSearchService.getSoldAppraisalData(params).toPromise();
    ...
    getExcelData() {
      ...
      this.apiESaleyardService.postGetFile('awhwool/ExportToExcelSoldAppraisal', bodyData, 'blob')
        .subscribe(
          (resultBlob: Blob) => {
