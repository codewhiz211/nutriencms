...
@Component({
  selector: 'app-e-contract-grid-view',
  templateUrl: './e-contract-grid-view.component.html',
  styleUrls: ['./e-contract-grid-view.component.scss', '../../../../../shared/components/grid-view/grid-view.component.scss']
})
export class EContractGridViewComponent extends BaseGrid implements OnInit {
  ...
  constructor(
    ...
    super(elRef,toastr);//Biresh

    this.ProcessName = 'LMKLivestockLots';
    this.ViewName = '';
  ...
  getGridData() {
    ...
    this.listviewService.GridData(this._bodyData).subscribe(
      data => {        
        this.spinner.show();           
        super.BindData(data);          
        this.spinner.hide(); 
...
//Changes Based on Parent Transaction ID #1038
  ...
  deleteConfirmation(modelRef: NgbModalRef, Caller: EContractGridViewComponent) {
  ...
  deleteSelectedConfirmation(modelRef: NgbModalRef, Caller: EContractGridViewComponent) {
  ...
  createNewRecord(modelRef: NgbModalRef, Caller: EContractGridViewComponent) {
