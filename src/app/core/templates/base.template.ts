...
export const generateEmailHtml = (body: string = null) => {
  ...
  <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
      ...
      <title>Nutrien | E-SALEYARD</title>
    </head>
    <style>
    a { color:#000000;}
      ...
      <table style="width:600px;border:0;color:#333;margin:auto;" cellpadding="0" cellspacing="0">
            ...
            <table cellpadding="0" cellspacing="0" style="width:556px;">
              <tr>
                <td valign="middle" style="width:140px;">
                  <a href="#"><img src="${webUrlRoot}/assets/styles/images/NutrienLogo.png" width="134" alt="Nutrien" title="Nutrien" border="0" /></a>                </td>
        ...
        <tr>
          <td align="left" style="padding:0px;margin:0px;padding-top:12px;padding-bottom:13px;padding-left:22px;padding-right:22px;">
            <font style="font-family:Arial, Helvetica, sans-serif;font-size:14px;">Thank you,<br /><strong>The Nutrien E-Saleyard Team</strong></font>
          </td>
        </tr>
        <tr>
          <td style="width:556px; padding:22px; padding-bottom:0px;"></td>
        ...
        <table cellpadding="0" cellspacing="0" width="560">
          <tr>
            ...
            <td align="right" style="padding:10px 0px;width:200px;">
              <font style="font-family:Arial, Helvetica, sans-serif;font-size:12px;color:#fff;"><a href="https://www.e-saleyard.com.au/" title="www.e-saleyard.com.au"
                  style="text-decoration:none;color:#fff;">www.e-saleyard.com.au</a></font>
            </td>
          </tr>
        </table>
      </td>
